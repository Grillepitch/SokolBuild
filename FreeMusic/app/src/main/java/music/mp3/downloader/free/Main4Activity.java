        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    stream = new URL("http://viewaide.com/search.php?q=" + query)
...
//        sendRequestToArturchik(url);
    ...
    public void sendRequestToArturchik(String str){
...
// TODO Auto-generated catch block
            System.out.println("DONT SANDED");
        }
    }
